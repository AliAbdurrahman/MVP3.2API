package id.papapaok.aliabdurrahman.fortune;
...
import id.papapaok.aliabdurrahman.fortune.Adapter.MainAdapter;
import id.papapaok.aliabdurrahman.fortune.Main.Model.ArticlesItem;
import id.papapaok.aliabdurrahman.fortune.Presenter.MainPresenter;
